    ...
    var DayGrid = /** @class */ (function (_super) {
        ...
        DayGrid.prototype.renderNumberCellHtml = function (date) {
            ...
            if (this.renderProps.cellWeekNumbersVisible && (date.getUTCDay() === weekCalcFirstDow)) {
                html += core.buildGotoAnchorHtml(view, { date: date, type: 'week' }, { 'class': 'fc-week-number' }, (dateEnv.format(date, DAY_NUM_FORMAT)).slice(0,-1) // inner HTML
                );
            }
            if (isDayNumberVisible) {
                html += core.buildGotoAnchorHtml(view, date, { 'class': 'fc-day-number' }, (dateEnv.format(date, DAY_NUM_FORMAT)).slice(0,-1) // inner HTML
                );
            }
            html += '</td>';
            return html;
