...
(function (global, factory) {
    ...
    */
    ...
    The EventNonDateInput has been normalized (id => publicId, error).
    */
    ...
    */
    ...
    var DateEnv = /** @class */ (function () {
        ...
        DateEnv.prototype.add = function (marker, dur) {
            ...
            // 2020-02-04 : When the calendar add a month, I add a code for exception handling
            if(dur.months >= 1)
                a[2] = 1;
        ...
        DateEnv.prototype.subtract = function (marker, dur) {
            ...
            // 2020-02-04 : When the calendar subtract a month, I add a code for exception handling
            if(dur.months >= 1)
                a[2] = 1;
